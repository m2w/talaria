/*global document,jQuery,async,sessionStorage,location,console*/
var talaria = (function ($, async) {
    ...
    var byAscendingDate = function(commentA, commentB) {
     ...
     */
    var grabCommitsForFile = function(path, callback) {
    ...
    var grabCommentsForCommit = function(acc, commit, callback) {
    ...
    var aggregateCommentsForCommits = function(commits, callback) {
        if (commits.length !== 0) {
    ...
    var grabCommitComments = function(permalinkElement, cb) {
        ...
        if (cache === undefined) {
            async.waterfall([
                ...
                function (commits, callback) {
                    aggregateCommentsForCommits(commits, callback);
                }
    ...
    var retrieveGistComments = function(mapping) {
    ...
    var handleGistMapping = function(mapping, callback) {
    ...
    var addGistComments = function(mappings) {
